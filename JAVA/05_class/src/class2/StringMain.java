...
public class StringMain {
	public static void main(String[] args) {
		...
		if(a==b) System.out.println("a와 b의 참조값은 같다"); //true
		else System.out.println("a와 b의 참조값은 다르다"); 
		if(a.equals(b)) System.out.println("a와 b의 문자열은 같다"); //true
		...
		if(c==d) System.out.println("c와 d의 참조값은 같다"); //false
		else System.out.println("c와 d의 참조값은 다르다");
		if(c.equals(d)) System.out.println("c와 d의 문자열은 같다");//true
		else System.out.println("c와 d의 문자열은 다르다");
		System.out.println();		
		
		String e = "오늘 날짜는 " + 2023 + 12 + 29;
		System.out.println("e= " + e);
		System.out.println("문자열크기 = " + e.length());
		System.out.println();
